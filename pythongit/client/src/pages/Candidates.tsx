                ...
                <input
                  ...
                  onChange={async (e) => {
                    ...
                    try {
                      ...
                      const result = await response.json();
                      console.log('[FRONTEND] Received parse result:', result);
                      ...
                      if (result.data.address) {
                        setValue("location", result.data.address);
                      }
                      if (result.data.skills && result.data.skills.length > 0) {
                        setValue("skills", result.data.skills.join(', '));
                      }
                      if (result.data.resumeText) {
                        setValue("resumeText", result.data.resumeText);
                      }
                      if (result.data.fileName) {
                        setValue("resumeFilename", result.data.fileName);
                      }
